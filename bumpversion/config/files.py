...
def get_pep621_info(config_file: Optional[Pathlike] = None) -> Optional[PEP621Info]:
    ...
    toml_data = read_toml_file(config_path)
    project = toml_data.get("project", {})
    has_dynamic_version = "version" in project.get("dynamic", [])
    version = project.get("version") if not has_dynamic_version else None
    return PEP621Info(version=version)
