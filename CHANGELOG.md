...
- Fixed linting errors. [8196116](https://github.com/callowayproject/bump-my-version/commit/8196116eab9825b4f4589bd042386c804518f0a8)

### Other

- Bump codecov/codecov-action from 6 to 7 in the github-actions group. [430128e](https://github.com/callowayproject/bump-my-version/commit/430128e2cfc37fb6fa1a08e5eef47a53f9079ba6)
...
- [pre-commit.ci] pre-commit autoupdate. [8124a90](https://github.com/callowayproject/bump-my-version/commit/8124a90de40f5de325ab5668a05da166f65f1144)

    **updates:** - [github.com/astral-sh/ruff-pre-commit: v0.15.15 → v0.15.17](https://github.com/astral-sh/ruff-pre-commit/compare/v0.15.15...v0.15.17)

- [pre-commit.ci] pre-commit autoupdate. [da390f0](https://github.com/callowayproject/bump-my-version/commit/da390f001284c88b488df6e35f5eb4840a1e6392)

    **updates:** - [github.com/astral-sh/ruff-pre-commit: v0.15.8 → v0.15.15](https://github.com/astral-sh/ruff-pre-commit/compare/v0.15.8...v0.15.15)

- Bump softprops/action-gh-release from 2 to 3 in the github-actions group. [f966be5](https://github.com/callowayproject/bump-my-version/commit/f966be52a218eb59542d43d768a2694ca288e8da)
...
- Disable shell hooks in configuration defaults and models. [8a8aa51](https://github.com/callowayproject/bump-my-version/commit/8a8aa51ce031493b3edb5f8ecd86ec34c5779f00)

    Fixes #407

- Standardize Markdown usage in documentation by replacing deprecated `:::field-list` syntax with modern `///html`. Adjusted configurations in `mkdocs.yml` and `.changelog-config.yaml` to align with updated formatting. [8fac9fb](https://github.com/callowayproject/bump-my-version/commit/8fac9fb295d1ebf853a8c9b522a39edbc7aabf6e)

- [pre-commit.ci] pre-commit autoupdate. [6433302](https://github.com/callowayproject/bump-my-version/commit/6433302210048bec32c39211bad7090a5f72c262)

    **updates:** - [github.com/astral-sh/ruff-pre-commit: v0.15.1 → v0.15.8](https://github.com/astral-sh/ruff-pre-commit/compare/v0.15.1...v0.15.8)

- Bump codecov/codecov-action from 5 to 6 in the github-actions group. [b32d019](https://github.com/callowayproject/bump-my-version/commit/b32d019d721e6a53d7379a56e6a633a9b0b3eac9)
...
- Bump actions/download-artifact from 7 to 8 in the github-actions group. [14d8fa1](https://github.com/callowayproject/bump-my-version/commit/14d8fa122465bd367fe1616fa575131f629868d9)
...
- Update dependency versions (`pyproject.toml`, `.pre-commit-config.yaml`, and `uv.lock`); add `click-extra` plugin to mkdocs configuration. [c7954cb](https://github.com/callowayproject/bump-my-version/commit/c7954cb4f6377a269b10391d0707d24ff05b4e4d)

    Fixes #406

- Update dependency versions (`anyio`, `click`, `virtualenv`) and adjust constraints in `uv.lock` and `pyproject.toml`. [c2cf2be](https://github.com/callowayproject/bump-my-version/commit/c2cf2be0103b67d643a2c82dd336dfcabd6d4cdd)

    Fixes #410

- Update workflows to use `properdocs` instead of `mkdocs`; adjust linter exclusions in `pyproject.toml`. [b63b3dc](https://github.com/callowayproject/bump-my-version/commit/b63b3dc67ddaa43196f58ab05a0f4e91545d5163)

- Update tests to mock `httpx2` instead of `httpx` for download URL functionality. [cc78fd4](https://github.com/callowayproject/bump-my-version/commit/cc78fd4acc72476c871c258bad49b78aecd5d3aa)

- Update dependency constraints and versions in `uv.lock`. [ce7be1f](https://github.com/callowayproject/bump-my-version/commit/ce7be1f35e4973c40d5f27ee04b5c24216869403)

- Update CHANGELOG formatting for clarity and consistency. [64a55c3](https://github.com/callowayproject/bump-my-version/commit/64a55c3601f38ce5bea8dc29d4ddea4161627d63)
...
- Fix: Set default `is_flag` value to `False` in click_config. [6f5d13d](https://github.com/callowayproject/bump-my-version/commit/6f5d13dd01c9f8e53accad72990f3c1cb3f417b8)

- Fix Jinja template includes to use `.jinja` file extension consistently. [13b7902](https://github.com/callowayproject/bump-my-version/commit/13b790224ffb2c0aea554f9a1db5741e90cf046f)

### New

- Add Python 3.14 to GitHub Actions test matrix. [f8ff078](https://github.com/callowayproject/bump-my-version/commit/f8ff0783a2c82b9345a5de84ba3f92917c0eb35c)

### Other

- Bump Click dependency to version 8.3.1 for Python 3.10+. [c9db946](https://github.com/callowayproject/bump-my-version/commit/c9db9461bb7cef398430953d0c6430a442d3f70a)

- Bump click support to \<8.4. [be429e8](https://github.com/callowayproject/bump-my-version/commit/be429e8e99d492ae375e6480b4f9940ca0b7dc15)

    fixes #377

- Bump the github-actions group across 1 directory with 2 updates. [05edf97](https://github.com/callowayproject/bump-my-version/commit/05edf97baa237a6e628eb680179f60f66fa054ce)
...
- [pre-commit.ci] pre-commit autoupdate. [d2edfae](https://github.com/callowayproject/bump-my-version/commit/d2edfaed09266b4106751d5554418beb934824a1)

    **updates:** - [github.com/astral-sh/ruff-pre-commit: v0.14.6 → v0.14.10](https://github.com/astral-sh/ruff-pre-commit/compare/v0.14.6...v0.14.10)
